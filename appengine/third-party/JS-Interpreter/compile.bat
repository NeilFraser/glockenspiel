@REM Script for generating the compiled acorn_interpreter_simple.js file.
@REM For Windows.
...
@REM  3. Use a web browser to download the compiler and place it in the appengine directory.
